...
create table "DRUGS" ("id" SERIAL NOT NULL PRIMARY KEY,"userInput" VARCHAR(254) NOT NULL,"userToken" VARCHAR(254) NOT NULL,"resolved_medication_product_id" BIGINT);
create table "DRUG_GROUPS" ("id" SERIAL NOT NULL PRIMARY KEY,"name" VARCHAR(254) NOT NULL);
...
create table "EXPRESSION_TERMS" ("label" VARCHAR(254) NOT NULL PRIMARY KEY,"drug_type_id" BIGINT,"drug_group_id" BIGINT,"statement_template" VARCHAR(254),"display_condition" VARCHAR(254),"comparison_operator" VARCHAR(254),"age" INTEGER);
create table "EXPRESSION_TERMS_RULES" ("expression_term_label" VARCHAR(254) NOT NULL,"rule_id" BIGINT NOT NULL);
alter table "EXPRESSION_TERMS_RULES" add constraint "EXPRESSION_TERMS_RULES_PK" primary key("expression_term_label","rule_id");
create table "GENERIC_TYPES" ("id" SERIAL NOT NULL PRIMARY KEY,"name" VARCHAR(254) NOT NULL);
...
create table "MEDICATION_PRODUCTS" ("id" SERIAL NOT NULL PRIMARY KEY,"name" VARCHAR(254) NOT NULL);
create unique index "MEDICATION_PRODUCTS_NAME_INDEX" on "MEDICATION_PRODUCTS" ("name");
create table "RULES" ("id" SERIAL NOT NULL PRIMARY KEY,"name" VARCHAR(254) NOT NULL,"condition_expression" VARCHAR(254) NOT NULL,"source" VARCHAR(254),"note" VARCHAR(254));
...
create table "STATEMENT_TERMS_USER_SESSIONS" ("user_session_token" VARCHAR(254) NOT NULL,"statement_term_label" VARCHAR(254) NOT NULL,"text_hash" VARCHAR(254) NOT NULL,"conditional" BOOLEAN DEFAULT false NOT NULL);
alter table "STATEMENT_TERMS_USER_SESSIONS" add constraint "STATEMENT_TERMS_USER_SESSIONS_PK" primary key("user_session_token","statement_term_label","text_hash","conditional");
create table "SUGGESTION_TEMPLATES" ("id" SERIAL NOT NULL PRIMARY KEY,"name" VARCHAR(254) NOT NULL,"text" VARCHAR(254) NOT NULL,"explanatory_note" VARCHAR(254));
