...
create table "EXPRESSION_TERMS" ("label" VARCHAR NOT NULL PRIMARY KEY,"drug_type_id" BIGINT,"drug_group_id" BIGINT,"statement_template" VARCHAR,"display_condition" VARCHAR,"comparison_operator" VARCHAR,"age" INTEGER);
...
create table "STATEMENT_TERMS_USER_SESSIONS" ("user_session_token" VARCHAR NOT NULL,"statement_term_label" VARCHAR NOT NULL,"text_hash" VARCHAR NOT NULL,"conditional" BOOLEAN DEFAULT false NOT NULL);
