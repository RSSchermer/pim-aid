...
create table "EXPRESSION_TERMS_RULES" ("expression_term_label" BIGINT NOT NULL,"rule_id" BIGINT NOT NULL);
...
alter table "EXPRESSION_TERMS_RULES" add constraint "EXPRESSION_TERMS_RULES_EXPRESSION_TERM_FK" foreign key("expression_term_label") references "EXPRESSION_TERMS"("id") on update NO ACTION on delete NO ACTION;
