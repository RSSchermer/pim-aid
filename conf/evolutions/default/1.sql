...
create table "RULES" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"name" VARCHAR(254) NOT NULL,"condition_expression" VARCHAR(254) NOT NULL,"source" VARCHAR(254),"note" VARCHAR(254));
